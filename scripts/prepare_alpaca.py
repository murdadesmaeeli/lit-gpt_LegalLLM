...
def prepare(
    ...
    train_set,test_set=pickle.load(open('/home/public_code_2023/lit-gpt/data/alpaca/BillSum/train.pkl','rb')),\
    pickle.load(open('/home/public_code_2023/lit-gpt/data/alpaca/BillSum/test.pkl','rb'))
